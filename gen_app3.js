...
let code = `
    ...
    <div id="main-viewport" class="flex-1 relative overflow-hidden flex flex-col">
      ...
      <div id="tab-home" class="tab-pane absolute inset-0 flex flex-col bg-black">
        ...
        <img src="images/Home.png" alt="Home Reel" class="w-full h-full object-cover">
        ...
        <div class="absolute top-3 left-4 right-4 z-20 flex justify-between items-center pt-2">
          ...
          <button onclick="app.openLinkPay()" class="px-3 py-1 rounded-full btn-glow-blue text-white font-bold text-[11px] flex items-center gap-1 shadow-md">
        ...
        <div class="absolute right-3 bottom-20 z-20 flex flex-col items-center gap-4">
          ...
          <button onclick="app.openLinkPay()" class="flex flex-col items-center group">
            <div class="w-11 h-11 rounded-full btn-glow-blue flex items-center justify-center text-white shadow-[0_0_16px_rgba(37,99,235,0.6)]">
              <i data-lucide="wallet" class="w-5 h-5"></i>
            </div>
            <span class="text-[10px] font-extrabold text-cyan-300 mt-1">VOTE</span>
          </button>

          <button onclick="app.toggleLike(this)" class="flex flex-col items-center text-white">
            <div class="p-2 rounded-full glass-btn">
              <i data-lucide="heart" class="w-5 h-5"></i>
            </div>
            <span class="like-counter text-[10px] font-semibold mt-0.5">14.2k</span>
          </button>

          <button onclick="alert('💬 842 Comments from Audience & Fans!')" class="flex flex-col items-center text-white">
            <div class="p-2 rounded-full glass-btn">
          ...
          <button onclick="alert('↗️ Performance link copied to clipboard!')" class="flex flex-col items-center text-white">
            <div class="p-2 rounded-full glass-btn">
        ...
        <!-- Bottom Contestant Info Overlay -->
      ...
      <div id="tab-discover" class="tab-pane absolute inset-0 hidden flex-col bg-[#05070D] p-4 overflow-y-auto no-scrollbar pb-20">
        ...
        <div class="glass-panel rounded-2xl p-4 border-blue-500/30 mb-3.5 relative overflow-hidden">
          ...
          <button onclick="app.handleCreate()" class="mt-3 px-3 py-1.5 rounded-xl btn-glow-blue text-white font-bold text-[11px] flex items-center gap-1 shadow">
            <span>Enter Task</span>
            <i data-lucide="arrow-right" class="w-3 h-3"></i>
          </button>
        </div>

        <!-- Sunday Live Show Card -->
        <div onclick="app.openLiveShow()" class="glass-panel rounded-2xl p-3.5 border-blue-500/30 mb-3.5 cursor-pointer active:scale-98 transition">
